...
class SimpleActionClient : public rclcpp::Node {
    public:
        ...
        : Node("simple_action_client"){
            ...
            timer_ = create_wall_timer(std::chrono::seconds(1), std::bind(&SimpleActionClient::timer_callback, this));
        }
    private:
        ...
        void timer_callback() {
            ...
            send_goal_options.goal_response_callback = std::bind(&SimpleActionClient::goal_callback, this, _1);
        ...
        void goal_callback(const rclcpp_action::ClientGoalHandle<bumperbot_msgs::action::Fibonacci>::SharedPtr &goal_handle) {
            if(!goal_handle) {
        ...
        void feedback_callback(rclcpp_action::ClientGoalHandle<bumperbot_msgs::action::Fibonacci>::SharedPtr , const std::shared_ptr<const bumperbot_msgs::action::Fibonacci::Feedback> feedback) {
            std::stringstream ss;
        ...
        void result_callback(const rclcpp_action::ClientGoalHandle<bumperbot_msgs::action::Fibonacci>::WrappedResult result) {
            switch(result.code) {
                ...
                case rclcpp_action::ResultCode::CANCELED:
                    ...
                    return;
                default:
                    RCLCPP_ERROR(get_logger(), "Uknown result code");
                    return;
            }
