...
def generate_launch_description():
    bumperbot_controller_package = get_package_share_directory("bumperbot_controller")
    ...
    twist_mux_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "config_topic": os.path.join(bumperbot_controller_package, "config", "twist_mux_topics.yaml"),
            "config_locks": os.path.join(bumperbot_controller_package, "config", "twist_mux_locks.yaml"),
            "config_joy": os.path.join(bumperbot_controller_package, "config", "twist_mux_joy.yaml"),
