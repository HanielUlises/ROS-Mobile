...
{
  new (message_memory) test_package::srv::OddEvenCheck_Request(_init);
}

void OddEvenCheck_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<test_package::srv::OddEvenCheck_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OddEvenCheck_Request_message_member_array[1] = {
  {
    ...
    offsetof(test_package::srv::OddEvenCheck_Request, number),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OddEvenCheck_Request_message_members = {
  "test_package::srv",  // message namespace
  "OddEvenCheck_Request",  // message name
  1,  // number of fields
  sizeof(test_package::srv::OddEvenCheck_Request),
...
{
  return &::test_package::srv::rosidl_typesupport_introspection_cpp::OddEvenCheck_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_package, srv, OddEvenCheck_Request)() {
  return &::test_package::srv::rosidl_typesupport_introspection_cpp::OddEvenCheck_Request_message_type_support_handle;
}
...
void OddEvenCheck_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) test_package::srv::OddEvenCheck_Response(_init);
}

void OddEvenCheck_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<test_package::srv::OddEvenCheck_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OddEvenCheck_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_package::srv::OddEvenCheck_Response, decision),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OddEvenCheck_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(test_package::srv::OddEvenCheck_Response),
...
{
  return &::test_package::srv::rosidl_typesupport_introspection_cpp::OddEvenCheck_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_package, srv, OddEvenCheck_Response)() {
  return &::test_package::srv::rosidl_typesupport_introspection_cpp::OddEvenCheck_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers OddEvenCheck_service_members = {
  "test_package::srv",  // service namespace
  "OddEvenCheck",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<test_package::srv::OddEvenCheck>()
...
get_service_type_support_handle<test_package::srv::OddEvenCheck>()
{
  ...
  auto service_type_support =
    &::test_package::srv::rosidl_typesupport_introspection_cpp::OddEvenCheck_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::test_package::srv::OddEvenCheck_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::test_package::srv::OddEvenCheck_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_package, srv, OddEvenCheck)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<test_package::srv::OddEvenCheck>();
}
