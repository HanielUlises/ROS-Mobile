...
class Metaclass_TurnCamera(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from test_package.srv import _turn_camera
...
class TurnCamera(metaclass=Metaclass_TurnCamera):
    from test_package.srv._turn_camera import TurnCamera_Request as Request
    from test_package.srv._turn_camera import TurnCamera_Response as Response
