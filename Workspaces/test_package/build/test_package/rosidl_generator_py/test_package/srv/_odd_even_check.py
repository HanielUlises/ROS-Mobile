...
class Metaclass_OddEvenCheck(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from test_package.srv import _odd_even_check
...
class OddEvenCheck(metaclass=Metaclass_OddEvenCheck):
    from test_package.srv._odd_even_check import OddEvenCheck_Request as Request
    from test_package.srv._odd_even_check import OddEvenCheck_Response as Response
